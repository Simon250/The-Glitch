...
void main() {
	...
	lightDir[0] = normalize(lightPos[0] - vertPos); /// Create the light direction. I do the math with in class 
	lightDir[1] = normalize(lightPos[1] - vertPos); /// Create the light direction. I do the math with in class 
